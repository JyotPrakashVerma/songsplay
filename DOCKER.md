...
| Command                                                   | What starts                          |
| --------------------------------------------------------- | ------------------------------------ |
| `docker compose up -d`                                    | SongsPlay                            |
| `docker compose --profile pocketbase up -d`               | SongsPlay + PocketBase               |
| `docker compose --profile dev up -d`                      | SongsPlay + Dev server               |
| `docker compose --profile dev --profile pocketbase up -d` | SongsPlay + Dev server + PocketBase  |
...
The legacy application uses Appwrite for user authentication. The active SongsPlay player does not require authentication.
...
The legacy application uses PocketBase to store user data. The active SongsPlay player does not require it.
