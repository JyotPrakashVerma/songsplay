export async function onRequest(context) {
    ...
    if (isBot) {
        ...
        const metaHtml = `
            ...
            <head>
                <meta charset="UTF-8">
                <title>SongsPlay | Settings</title>
